...
if __name__ == "__main__":   
    ...
    Key_Col = len(tsv_rdd.first())-1 #which col represents row nbr
    AVF_Cols = [] #which col in calculating AVF
    Num_Cols = []
    Cat_Cols = []
    ...
    #put numerical data into buckets
    current_col = 0
    current_bucket = 0
    bucket_min = 0
    for k in Num_Cols:
    ...
    #AVF cols list is the union of Num and Cat Cols
